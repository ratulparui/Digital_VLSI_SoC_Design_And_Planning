...
- [Sky130 Day 2 - Good floorplan vs bad floorplan and introduction to library cells](#section-2)
  ...
  - [Subsection 3.3](#subsection-33)
    - [SKY_L1 - Utilization factor and aspect ratio](#sub-subsection-331)
    - [SKY_L2 - Concept of pre-placed cells](#sub-subsection-332)
    - [SKY_L3 - De-coupling capacitors](#sub-subsection-333)
    - [SKY_L4 - Power planning](#sub-subsection-334)
    - [SKY_L5 - Pin placement and logical cell placement blockage](#sub-subsection-335)
    - [SKY_L6 - Steps to run floorplan using OpenLANE](#sub-subsection-336)
    - [SKY_L7 - Review floorplan files and steps to view floorplan](#sub-subsection-337)
    - [SKY_L8 - Review floorplan layout in Magic](#sub-subsection-338)
    - [SKY_L8 - Review floorplan layout in Magic](#sub-subsection-339))
- [Section 4](#section-4)
